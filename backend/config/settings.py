...
MAX_VIDEO_BYTES = int(os.environ.get("MAX_VIDEO_BYTES", 500_000_000))
...
DEFAULT_USER_DAILY_DOWNLOADS = int(os.environ.get("DEFAULT_USER_DAILY_DOWNLOADS", "5"))
DEFAULT_USER_QUEUE_LIMIT = int(os.environ.get("DEFAULT_USER_QUEUE_LIMIT", "5"))
